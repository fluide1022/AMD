...
class GaussianDiffusion:
    ...
    # Autoregressive loss needs to return output to the next segment of autoregressive encoding
    def training_losses_autoreg(self, model, x_start, t, model_kwargs=None, noise=None, dataset=None):
        """
        Compute training losses for a single timestep.
