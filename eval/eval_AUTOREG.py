...
from data_loaders.humanml.motion_loaders.model_motion_loaders import get_autoreg_amd_loader  # get_motion_loader
...
if __name__ == '__main__':
    ...
    eval_motion_loaders = {
        'vald': lambda: get_autoreg_amd_loader(
            model, diffusion, args.batch_size,
            gen_loader, mm_num_samples, mm_num_repeats, gt_loader.dataset.opt.max_motion_length * 2, num_samples_limit, args.guidance_param
        )
    }
