...
from data_loaders.humanml.motion_loaders.model_motion_loaders import get_joint_amd_loader  # get_motion_loader
...
if __name__ == '__main__':
    ...
    split = 'test'
    gt_loader = get_dataset_loader(name='autoreg', batch_size=args.batch_size, data_root=args.data_dir, num_frames=None, split=split, hml_mode='gt')
    gen_loader = get_dataset_loader(name='autoreg', batch_size=args.batch_size, data_root=args.data_dir, num_frames=None, split=split, hml_mode='eval')
    ...
    eval_motion_loaders = {
        'vald': lambda: get_joint_amd_loader(
