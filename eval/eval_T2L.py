...
from data_loaders.humanml.motion_loaders.model_motion_loaders import get_t2l_amd_loader  # get_motion_loader
from data_loaders.humanml.utils.metrics import *
from data_loaders.humanml.networks.evaluator_wrapper import EvaluatorAMDWrapper
...
if __name__ == '__main__':
    # t2l_checkpoints_name = '1_humanml_only_t2l'
    # t2l_checkpoints_name = '2_humanma_only_t2l'
    t2l_checkpoints_name = '2_c_humanma_only_t2l'
    # t2l_checkpoints_name = '4_humanma_sliced_on_humanml_t2l'
    # t2l_checkpoints_name = '5_humanma_sliced_and_humanml_t2l'
    ...
    split = 'test'
    gt_loader = get_dataset_loader(name=args.dataset, batch_size=args.batch_size, data_root=args.data_dir, num_frames=None, split=split, hml_mode='gt')
    # gen_loader = get_dataset_loader(name=args.dataset, batch_size=1, data_root=args.data_dir, num_frames=None, split=split, hml_mode='eval')
    gen_loader = get_dataset_loader(name=args.dataset, batch_size=args.batch_size, data_root=args.data_dir, num_frames=None, split=split, hml_mode='eval')
    ...
    eval_motion_loaders = {
        'vald': lambda: get_t2l_amd_loader(
    ...
    eval_wrapper = EvaluatorAMDWrapper(args.dataset, dist_util.dev())
